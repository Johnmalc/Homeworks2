...
public class CashMachine {
	...
	// Array als Speicherplatz für die spateren Accounts
	...
	public void withdraw(int amount) {
		if (status == State.PIN_CORRECT) {
			if (benuezterAccount.getOverdraft()
					+ benuezterAccount.getBankDeposit() >= amount) {
				benuezterAccount.setBankDeposit((benuezterAccount
						.getBankDeposit() - amount));
				myGui.infobox.setText("Neuer Kontobetrag="
						+ benuezterAccount.getBankDeposit());
			}
	...
	public void accountStatement() {
		if (status == (State.PIN_CORRECT)) {
			myGui.infobox.setText("Kontonummer: "
					+ benuezterAccount.getAccountNumber());
			myGui.infobox.setText("<html>" + myGui.infobox.getText() + "<br/>"
					+ "Dispokredit des Kontos: "
					+ benuezterAccount.getOverdraft());
			myGui.infobox.setText(myGui.infobox.getText() + "<br/>"
					+ "Kontoguthaben: " + benuezterAccount.getBankDeposit()
					+ "</html>");
		}
	}
	// ==============================================================================
	public void ejectCashCard() {
		if ((status == State.CARD_INSERTED) || status == (State.PIN_CORRECT)) {
			...
			status = State.READY;
			myGui.infobox
					.setText("Entnehmen Sie Ihre Karte....Automat ist Ready");
		}
	}
	// ==============================================================================
