...
public class Geldautomat {
	...
	private JButton pinBestatigen = new JButton(" PIN bestatigen");
	...
	private JComboBox<Integer> betrag = new JComboBox<Integer>();
	...
	public void fenster(final CashMachine cashMachine) {
		...
		pinBestatigen.addActionListener(new ActionListener() {
	...
	public void setActiveComponents() {
		...
		if (CashMachine.getStatus() == Status.READY) {
			...
			pinBestatigen.setEnabled(false);
